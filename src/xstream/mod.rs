...
pub use merge::{merge_concat, merge_with_strategy, merge_with_collision_policy, MergeStrategy, CollisionPolicy};
pub use gate::{xor_gate, multi_xor_gate, timed_gate, xor_gate_with_state, GateMode, GateState};
